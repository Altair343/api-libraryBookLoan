...
import com.alt.libraryBook.dto.ErrorDTO;
...
public class APIExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    @ExceptionHandler(AltException.class)
    public ResponseEntity<ErrorDTO> duplicateResource(AltException e, WebRequest request) {
